...
<body>
	...
	if ($result->num_rows > 0)
	{
		while($row=$result->fetch_assoc())
		{
			...
			echo '<form method="POST" action="addAns.php"><fieldset><legend>Answer</legend><textarea cols="100" rows="5" name="Answer">'.$row["Answer"].'</textarea><br><input type="radio" name="ID" value="'.$row["Name"].'" checked>I understand this will edit the above Answer.<br><input type="hidden" name="Tname" value="college"><input type="submit" value="Submit"></form></fieldset>';
		}
	}
		else
